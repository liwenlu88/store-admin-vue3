...
const oldPwd = async () => {
    ...
    request({
        ...
        if (res.data.status === 200 && res.data.message === '旧密码正确') {
            // 解除密码输入框的禁用
...
<template>
    <div class="container">
        <div class="user-left">
            <div class="info-box">
                <el-form :model="info" :rules="infoRules" :hide-required-asterisk="true" label-position="top"
                    label-width="120px">
                    <div class="center">
                        <h2 class="form-title">
                            <span>个人信息</span>
        ...
        <div class="pwd-box">
            <el-form ref="form" :model="pwd" :rules="pwdRules" :hide-required-asterisk="true" label-position="top"
                label-width="120px">
                <div class="center">
                    <h2 class="form-title">
                        <span>修改密码</span>
                    ...
                    <el-form-item label="旧密码" prop="oldPassword">
                        <el-input v-model="pwd.oldPassword" type="password" placeholder="输入旧密码" clearable show-password
                            @change="oldPwd" />
                    </el-form-item>
                    <el-form-item label="新密码" prop="newPassword">
                        <el-input :disabled="pwdState" v-model="pwd.newPassword" type="password" placeholder="输入新密码"
                            clearable show-password />
                    </el-form-item>
                    <el-form-item label="确认密码" prop="confirmPassword">
                        <el-input :disabled="pwdState" v-model="pwd.confirmPassword" type="password" placeholder="确认新密码"
                            clearable show-password />
                    </el-form-item>
